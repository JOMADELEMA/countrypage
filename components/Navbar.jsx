    ...
    return (
        <>
            <div className="hidden lg:flex justify-between gap-10 text-amber-100 mt-3">
                ...
                <div className="mr-10 border text-black border-amber-200 bg-amber-300 hover:bg-amber-200 rounded-full flex text-gray font-semibold w-32 h-8 self-center items-center justify-center shadow-md cursor-pointer">
                    EXPLORE
                </div>
            </div>
        </>
