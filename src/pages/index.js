    ...
    <>
        ...
        <div className="w-full h-160 bg-150 bg-top md:bg-cover bg-no-repeat flex flex-col bg-arco relative">
          ...
          onClick={()=>toggleSidebar(sidebarVisible)}
            size={48}
            color="white"
            className="ml-5 mt-5 absolute cursor-pointer"
          />
          <h1 className="text-7xl font-semibold text-white drop-shadow-lg mt-64 self-center">
            GUATEMALA
          </h1>
        ...
        <div className="mt-20 mx-10 flex justify-center">
          ...
          <div
            id="slider"
            className="relative flex col ml-5 w-6 place-items-center"
          >
            <div
              id="slider-base"
