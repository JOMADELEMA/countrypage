  ...
  return (
    <>
      <div className="w-full h-160 bg-150 bg-top md:bg-cover bg-no-repeat flex flex-col bg-arco relative">
        ...
        />
        <h1 className="text-7xl lg:text-9xl font-semibold text-white drop-shadow-lg mt-64 lg:mt-40 self-center">
          GUATEMALA
        </h1>
      ...
      <div className="grid gap-8 grid-cols-2 grid-rows-2 lg:flex lg:justify-around mx-10">
        <div className="-translate-y-16 place-self-center cursor-pointer flex flex-col hover:saturate-150 text-white hover:text-amber-50 hover:font-semibold">
          <div className=" rounded-full h-24 w-24  bg-antigua-square bg-cover self-center hover:border-2 border-amber-100"></div>
          <p className="text-md text-center">Sample text 1</p>
          <p className="text-3xl text-center">La Antigua</p>
        </div>
        <div className="-translate-y-16 place-self-center cursor-pointer flex flex-col hover:saturate-150 text-white hover:text-amber-50 hover:font-semibold">
          <div className=" rounded-full h-24 w-24  bg-lago-square bg-cover self-center hover:border-2 border-amber-100"></div>
          <p className="text-md text-center">Sample text 1</p>
        ...
        <div className="-translate-y-10 lg:-translate-y-16 place-self-center cursor-pointer flex flex-col hover:saturate-150 text-white hover:text-amber-50 hover:font-semibold">
          <div className="rounded-full h-24 w-24  bg-tikal-square bg-cover self-center hover:border-2 border-amber-100"></div>
          <p className="text-md text-center">Sample text 1</p>
      ...
      <div className="lg:flex lg:flex-row-reverse lg:justify-between">
        <div
          className=" mt-20 mx-10 flex flex-col lg:w-160"
          id="guatemalan-culture"
        >
          <h1 className="text-amber-50 text-2xl font-semibold mb-5 text-center">
            Guatemalan Culture
          </h1>
          <p className="text-amber-50 text-md mb-5">
          ...
          <p className="text-amber-50 text-md">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum
            cumque est reiciendis et culpa tempore pariatur, magnam ducimus
            cupiditate, quas ea cum libero unde! Accusantium delectus quae quam
          ...
          <div className="border border-amber-200 bg-amber-300 hover:bg-amber-200 rounded-full flex text-gray font-semibold w-32 h-8 self-center items-center justify-center shadow-md cursor-pointer mt-8">
            Learn more
          </div>
        </div>

        <div className="mt-20 mx-10 flex justify-center lg:w-96 place-items-center">
          ...
          <div
            id="slider"
            className="relative flex col ml-5 w-6 lg:h-80 place-items-center"
          >
            <div
              id="slider-base"
              className="h-40 w-1 bg-white rounded-full absolute place-center left-2"
            ></div>
            <div
              id="slider-thumb"
              className="h-10 w-4 bg-amber-300 rounded-full cursor-pointer absolute left-0.5"
            ></div>
          </div>
        </div>
      </div>
